...
<?php 
    ...
    $sqls = "select * from donor where id='$id'";
    $ress = mysqli_query($conn, $sqls);
		...
		$address = $_POST['address'];
                     $sql = "update  donor set id='$id',name='$name',email='$email',mobile='$mobile',gender='$gender',bgroup='$bgroup',address='$address' where id='$id'";
